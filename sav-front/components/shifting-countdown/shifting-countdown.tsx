...
interface IShiftingCountdownProps {
  from: string
  title: string
}
...
const ShiftingCountdown = ({
  ...
  return (
    <div className='p-8 bg-gradient-to-br from-primary-600 to-secondary-600 prose-lg'>
...
const CountdownItem = ({ num, text }: { num: number; text: string }) => {
  return (
    <div className='font-mono  w-1/4 h-24 md:h-36 flex flex-col gap-1 md:gap-2 items-center justify-center border-r-[1px] border-accent-200'>
